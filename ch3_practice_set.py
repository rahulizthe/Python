...
#--------solution 3 
paragraph = "why suppose to be out baby grab your coffee vibe out in a good time daily."
...
##solution 5
letter = "Dear Rahul,This python course is nice! Thanks!"
letterSorted = "Dear Rahul,\n\tThis python course is nice!\nThanks!"
print(letterSorted)
